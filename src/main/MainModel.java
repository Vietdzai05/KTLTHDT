...
public class MainModel {
	    ...
	    public static void main(String[] args) throws CloneNotSupportedException, SQLException {
	        ...
	        List<model.XeHoi> cars = new ArrayList<>();
	        cars.add(new model.XeHoi(1, "Kia", 100, 1250000, new model.DongCo("Dong co xang", 147)));
	        cars.add(new XeHoi(2, "BMW", 100, 3890000, new DongCo("Dong co xang", 107)));
	        cars.add(new XeHoi(3, "Mitsubishi", 100, 6500000, new DongCo("Dong co xang", 105)));
	        cars.add(new XeHoi(4, "Lamborghini", 100, 6080000, new DongCo("Dong co xang", 110)));
	        ...
	        lt.add(new LapTop(1, "Dell", 123, 14000, 4, "16GB DDR4"));
	        lt.add(new LapTop(2, "Macbook", 1034, 14670, 8, "8GB DDR4"));
	        lt.add(new LapTop(3, "Lenovor", 201, 13290, 4, "6GB DDR4"));
	        lt.add(new LapTop(4, "HP", 101, 8800, 4, "8GB DDR3"));
	        lt.add(new LapTop(5, "Asus", 120, 16490, 4, "8GB DDR4"));
	        lt.add(new LapTop(6, "Hewlett-Packard", 1500, 13490, 4, "6GB DDR4"));
	        lt.add(new LapTop(7, "Acer", 200, 16490, 4, "8GB DDR4"));

	        List<SinhVien> dssv = new ArrayList<>();
	        dssv.add(new SinhVien("Đinh Đức Việt", "9876543210", new LopHoc("CNTT")));
	        dssv.add(new SinhVien("Hồ Minh Tuyên", "0123456789", new LopHoc("CNTT")));
	        ...
	        sanPhams1.add(new XeHoi(1, "Kia", 100, 1250000, new DongCo("Dong co xang", 147)));
	        
	        List<SanPham> sanPhams2 = new ArrayList<>();
	        sanPhams2.add(new LapTop(2, "Dell", 123, 14000, 4, "16GB DDR4"));
...
//	                    break;
    ...
    public static void showMenu() {
        ...
        System.out.println("********************************************");
        System.out.println("* |     Quản Lý Đồ Án Của Sinh Viên         | *");
        System.out.println("********************************************");
    ...
    public static void hienthidanhsachxehoi(List<XeHoi> cars) {
        System.out.println("\nDanh sách các xe hơi:");
        System.out.println("|---------------------------------------------------------------------------------------------------------------------|");
    ...
    public static void timkiemXe(List<XeHoi> cars, Scanner sc) {
        ...
        if (vitri >= 0) {
            // Tìm thấy mục
            hienthidanhsachxehoi(Collections.singletonList(cars.get(vitri))); // Hiển thị thông tin xe hơi được tìm thấy
        } else {
            // Không tìm thấy mục
